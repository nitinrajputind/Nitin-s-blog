      ...
      <div className="max-w-2xl mx-auto p-3 text-center">
        <div>
          ...
          <div className="text-md text-gray-500 flex flex-col gap-6">
            <p>
              Welcome to Nitin&apos;s Blog! This blog was created by Nitin
              Rajput as a personal project to share his thoughts and ideas with
              the world. Nitin is a passionate developer who loves to write
            ...
            <p>
              ...
              programming languages. Nitin is always learning and exploring new
